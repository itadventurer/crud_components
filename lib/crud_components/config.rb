...
module CrudComponents
  ...
  class Config
    ...
    DEFAULT_CSS = {
      ...
      nested_row: 'mb-2',
      nested_row_separated: 'border rounded p-2',
      nested_add: 'btn btn-sm btn-outline-secondary',
      nested_remove: 'btn btn-sm btn-outline-danger',
      nested_destroy: 'form-check small',
      nested_destroy_input: 'form-check-input',
      nested_destroy_label: 'form-check-label text-muted',
